...
export class StudentAccountDeletion extends React.Component {
  ...
  render() {
    ...
    const loseAccessText = StringUtils.interpolate(
      gettext('You may also lose access to Statements of Accomplishment. If you want to make a copy of these for your records before proceeding with deletion, {htmlStart}print or download your Statements of Accomplishment{htmlEnd}.'),
      {
