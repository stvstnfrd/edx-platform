...
REGISTRATION_FOOTER_DISCLAIMER_HTML = ENV_TOKENS.get(
    'REGISTRATION_FOOTER_DISCLAIMER_HTML', REGISTRATION_FOOTER_DISCLAIMER_HTML
)
REGISTRATION_ADD_PRIVACY_TO_TOS_CHECKBOX = ENV_TOKENS.get(
    'REGISTRATION_ADD_PRIVACY_TO_TOS_CHECKBOX', REGISTRATION_ADD_PRIVACY_TO_TOS_CHECKBOX
)
