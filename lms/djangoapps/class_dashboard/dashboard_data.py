...
from .utils import construct_problem_data
from .utils import get_non_student_list
from .utils import get_problem_set_grade_distrib_api
from .utils import get_problem_grade_distribution_api
from .utils import PROB_TYPE_LIST
...
def get_problem_grade_distribution(course_id):
    ...
    """
    prob_grade_distrib, total_student_count = get_problem_grade_distribution_api(course_id)
    if prob_grade_distrib and total_student_count:
...
def get_problem_set_grade_distrib(course_id, problem_set):
    ...
    """
    prob_grade_distrib = get_problem_set_grade_distrib_api(course_id, problem_set)
    if prob_grade_distrib:
...
def get_students_opened_subsection(request, csv=False):
    ...
    students = models.StudentModule.objects.select_related('student').filter(
        ...
        student_id__in=get_non_student_list_from_request(request),
