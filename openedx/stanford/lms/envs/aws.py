...
FOOTER_DISCLAIMER_TEXT = ENV_TOKENS.get('FOOTER_DISCLAIMER_TEXT', FOOTER_DISCLAIMER_TEXT)
FOOTER_EXTERNAL_COURSES_LINK = ENV_TOKENS.get('FOOTER_EXTERNAL_COURSES_LINK', FOOTER_EXTERNAL_COURSES_LINK)
...
LOGGING['handlers']['mail_admins']['class'] = 'openedx.stanford.djangoapps.admin_utils.logging.StanfordAdminEmailHandler'
MAX_ENROLLEES_FOR_METRICS_USING_DB = ENV_TOKENS.get('MAX_ENROLLEES_FOR_METRICS_USING_DB', MAX_ENROLLEES_FOR_METRICS_USING_DB)
MARKETO_API_URL = AUTH_TOKENS.get('MARKETO_API_URL', MARKETO_API_URL)
MARKETO_BLACKLIST_COURSES = AUTH_TOKENS.get('MARKETO_BLACKLIST_COURSES', MARKETO_BLACKLIST_COURSES)
MARKETO_BLACKLIST_ORGANIZATIONS = AUTH_TOKENS.get('MARKETO_BLACKLIST_ORGANIZATIONS', MARKETO_BLACKLIST_ORGANIZATIONS)
MARKETO_CLIENT_ID = AUTH_TOKENS.get('MARKETO_CLIENT_ID', MARKETO_CLIENT_ID)
MARKETO_CLIENT_SECRET = AUTH_TOKENS.get('MARKETO_CLIENT_SECRET', MARKETO_CLIENT_SECRET)
MARKETO_LIST_ID = AUTH_TOKENS.get('MARKETO_LIST_ID', MARKETO_LIST_ID)
